...
const page = () => {
  ...
  return (
    <section className="flex flex-col items-center justify-center px-6 md:px-28 -mt-[5vh] md:mt-1vh lg:mt-[10vh] mb-1 sm:mb-10 lg:mb-[60vh] text-center min-h-screen">
      {/* Judul */}
