...
const page = () => {
  ...
  return (
    <section className="px-6 md:px-28 py-14 lg:-py-3 mt-[8vh] flex flex-col md:flex-row-reverse justify-center items-center gap-6 md:gap-19 sm:mt-[27vh] md:mt-[25vh]">
