...
export default function LandingPage1() {
  return (
      <div className="h-screen flex flex-col -mt-[9vh] md:mt-0 -pt-6 md:pt-40 justify-center items-center text-center relative z-10">
        {/* Judul */}
        <h2 className="text-black text-[4vw] md:text-[2vw] lg:text-[2vw] font-black font-['Sofia_Sans_Condensed'] mb-2 md:mb-6 [text-shadow:_0px_0px_100px_rgb(170_109_0_/_1.00)]">
        ...
        <Link href={"https://www.instagram.com/reel/DMfQ6D9Titd/?igsh=YmFlajdyM211OTl4"}>
          <button className=" w-[45vw] h-[9vw] sm:h-[7vw] sm:w-[30vw]  md:w-[20vw] md:h-[6vw]  lg:w-[14vw] lg:h-[4.2vw] px-2 py-2 bg-amber-500 rounded-[30.4px] shadow-md inline-flex justify-center items-center ">
              ...
              <span className="text-neutral-800 text-[4vw] sm:text-[2.5vw] md:text-[1.5vw] font-bold font-['Sofia_Sans_Condensed']">Lihat Teaser</span>
