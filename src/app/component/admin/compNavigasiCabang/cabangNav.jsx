...
const CabangNavigasi = ({ onCategorySelect, onClose }) => {
  ...
  const subCategories = {
    ...
    "MLBB": ["Putra"],
    "Catur": ["Campuran"],
    "Solo Vocal": ["Putra", "Putri"],
  };

  const scaleFactor = 0.77; // sesuai scale-77
setPopupPosition({
  top: (rect.top + window.scrollY) / scaleFactor,
  left: rect.right / scaleFactor + 10,
});
  ...
  return (
    <div className="w-[30vw] scale-77 relative">
      <div className="w-full h-[700px] px-12 pt-9 pb-12 bg-[#806037] rounded-[30px] shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] border-[5px] border-white">
        <div className="w-full h-[731px] flex flex-col gap-2.5 overflow-hidden">
          {/* Olahraga */}
