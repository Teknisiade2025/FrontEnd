...
export default function NotFound() {
    return (
        ...
        <div
        className="min-h-screen w-full flex flex-col items-center bg-no-repeat bg-cover bg-center pt-16 sm:pt-20 lg:pt-28  bg-[url('/not-found/404mobile.svg')] sm:bg-[url('/not-found/Background 404 - Desktop.svg')]"
        style={{
